...
<div id="botBuscar" class="boton">Buscar</div>
<div id="botCambiar" class="boton">Asignar</div>
<?php echo form_open('articulos/cambioMuchosDo', 'id="cambioMuchos-form"') ?>
...
<table>
    <?php foreach ($articulos as $articulo): ?>
        <tr>
            ...
            <td class="precioNuevo"><?php echo $articulo->PRECIOVTA_ARTICULO ?></td>

...
<?php echo form_open($this->uri->uri_string()); ?>
    <table>
        <tr>
            <td><?php echo form_label('Contraseña Actual', $old_password['id']); ?></td>
        ...
        <tr>
            <td><?php echo form_label('Contraseña Nueva', $new_password['id']); ?></td>
        ...
        <tr>
            <td><?php echo form_label('Confirme Contraseña Nueva', $confirm_new_password['id']); ?></td>

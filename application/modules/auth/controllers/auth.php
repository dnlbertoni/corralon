...
//    $this->config->load('tank_auth');
    ...
    function login()
    {
        if ($this->tank_auth->is_logged_in()) {                                    // logged in
            ...
            $this->form_validation->set_rules('login', 'Usuario', 'trim|required|xss_clean');
            ...
            if ($this->tank_auth->is_max_login_attempts_exceeded($login)) {
                if ($data['use_recaptcha'])
                    $this->form_validation->set_rules('recaptcha_response_field', 'Codigo Confirmacion', 'trim|xss_clean|required|callback__check_recaptcha');
                else
            ...
            Template::set($data);
            Template::set_block('formulario', 'login_form');
            Template::render();
        }
    }
    ...
    function register()
    {
        if ($this->tank_auth->is_logged_in()) {                                    // logged in
            ...
            if ($captcha_registration) {
                if ($use_recaptcha) {
                    $this->form_validation->set_rules('recaptcha_response_field', 'Codigo de Confirmacion', 'trim|xss_clean|required|callback__check_recaptcha');
                } else {
                    $this->form_validation->set_rules('captcha', 'Codigo de Confirmacion', 'trim|xss_clean|required|callback__check_captcha');
                }
            }
            $data['errors'] = array();
            ...
            Template::set_block('formulario', 'register_form');
            Template::set($data);
    ...
    function send_again()
    {
        if (!$this->tank_auth->is_logged_in(FALSE)) {                            // not logged in or activated
            ...
            Template::set($data);
            Template::set_block('formulario', 'send_again_form');
            Template::render();
        }
    }
    ...
    function forgot_password()
    {
        if ($this->tank_auth->is_logged_in()) {                                    // logged in
            ...
            $this->form_validation->set_rules('login', 'Email o Usuario', 'trim|required|xss_clean');
            ...
            Template::set($data);
            Template::set_block('formulario', 'forgot_password_form');
            Template::render();
        }
    }
    ...
    function reset_password()
    {
        ...
        $this->form_validation->set_rules('new_password', 'Nueva Contraseña', 'trim|required|xss_clean|min_length[' . $this->config->item('password_min_length') . ']|max_length[' . $this->config->item('password_max_length') . ']|alpha_dash');
        $this->form_validation->set_rules('confirm_new_password', 'Confirme Nueva contraseña', 'trim|required|xss_clean|matches[new_password]');
        ...
        Template::set($data);
        Template::set_block('formulario', 'reset_password_form');
        Template::render();
    }
    ...
    function change_password()
    {
        if (!$this->tank_auth->is_logged_in()) {                                // not logged in or not activated
            ...
            $this->form_validation->set_rules('old_password', 'Contraseña Actual', 'trim|required|xss_clean');
            $this->form_validation->set_rules('new_password', 'Nueva Contraseña', 'trim|required|xss_clean|min_length[' . $this->config->item('password_min_length') . ']|max_length[' . $this->config->item('password_max_length') . ']|alpha_dash');
            $this->form_validation->set_rules('confirm_new_password', 'Confirme Nueva Contraseña', 'trim|required|xss_clean|matches[new_password]');
            ...
            Template::set($data);
            Template::set_block('formulario', 'change_password_form');
            Template::render();
        }
    }
    ...
    function change_email()
    {
        if (!$this->tank_auth->is_logged_in()) {                                // not logged in or not activated
            ...
            Template::set($data);
            Template::set_block('formulario', 'change_email_form');
            Template::render();
        }
    }
    ...
    function unregister()
    {
        if (!$this->tank_auth->is_logged_in()) {                                // not logged in or not activated
            ...
            Template::set($data);
            Template::set_block('formulario', 'unregister_form');
            Template::render();
        }
    }

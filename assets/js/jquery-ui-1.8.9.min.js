        ...
        options: {
            ...
            if (d.isArray(this.options.source)) {
                ...
                this.source = function (c, e) {
                    a.xhr && a.xhr.abort();
                    a.xhr = d.ajax({
                        url: f, data: c, dataType: "json", success: function (g, h, i) {
                            i === a.xhr && e(g);
                            a.xhr = null
                        }, error: function (g) {
                            g === a.xhr && e([]);
...
(function (c, j) {
    ...
    c.extend(c.ui.dialog, {
        version: "1.8.9", uuid: 0, maxZ: 0, getTitleId: function (a) {
            a = a.attr("id");
            if (!a) {
                this.uuid += 1;
                a = this.uuid
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (k) {
                ...
                if (c.options.range === true)if (c.orientation === "horizontal") {
                    ...
                    if (k === 1)c.range[e ? "animate" : "css"]({width: f - g + "%"}, {
                        queue: false,
                        duration: a.animate
                    })
                } else {
                    if (k === 0)c.range.stop(1, 1)[e ? "animate" : "css"]({bottom: f + "%"}, a.animate);
                    if (k === 1)c.range[e ? "animate" : "css"]({height: f - g + "%"}, {
                        queue: false,
                        duration: a.animate
                    })
                }
...
jQuery.effects || function (f, j) {
    ...
    f.extend(f.effects, {
        version: "1.8.9", save: function (c, a) {

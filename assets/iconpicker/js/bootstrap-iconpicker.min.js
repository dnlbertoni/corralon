...
+function (e) {
    ...
    o.ICONSET = {
        ...
        cols: 4,
        placement: "right"
    }, o.prototype.createButtonBar = function () {
        for (var o = this.options, t = e("<tr></tr>"), r = 0; r < o.cols; r++) {
            var a = e('<button class="btn btn-primary"><span class="glyphicon"></span></button>'), i = e('<td class="text-center"></td>');
            0 == r || r == o.cols - 1 ? (a.val(0 == r ? -1 : 1), a.addClass(0 == r ? "btn-previous" : "btn-next"), a.find("span").addClass(0 == r ? "glyphicon-arrow-left" : "glyphicon-arrow-right"), i.append(a), t.append(i)) : 0 == t.find(".page-count").length && (i.attr("colspan", o.cols - 2).append('<span class="page-count"></span>'), t.append(i))
        }
        o.table.find("thead").append(t)
    }, o.prototype.updateButtonBar = function (e) {
        var o = this.options, t = Math.ceil(o.icons.length / (o.cols * o.rows));
        o.table.find(".page-count").html(e + " / " + t);
        var r = o.table.find(".btn-previous"), a = o.table.find(".btn-next");
        1 == e ? r.addClass("disabled") : r.removeClass("disabled"), e == t ? a.addClass("disabled") : a.removeClass("disabled")
    }, o.prototype.bindEvents = function () {
        var o = this.options, t = this;
        o.table.find(".btn-previous, .btn-next").off("click").on("click", function () {
            var r = parseInt(e(this).val());
            t.changeList(o.page + r)
        }), o.table.find(".btn-icon").off("click").on("click", function () {
            t.select(e(this).val()), t.$element.popover("destroy")
        })
    }, o.prototype.select = function (o) {
        var t = this.options, r = this.$element;
        t.selected = e.inArray(o.replace(t.iconClassFix, ""), t.icons), -1 == t.selected && (t.selected = 0, o = t.iconClassFix + t.icons[t.selected]), "" != o && t.selected >= 0 && (t.icon = o, r.find("input").val(o), r.find("i").attr("class", "").addClass(t.iconClass).addClass(o), r.trigger({
            type: "change",
            icon: o
        }), t.table.find("button.btn-warning").removeClass("btn-warning"))
    }, o.prototype.switchPage = function (o) {
        var t = this.options;
        if (t.selected = e.inArray(o.replace(t.iconClassFix, ""), t.icons), "" != o && t.selected >= 0) {
            var r = Math.ceil((t.selected + 1) / (t.cols * t.rows));
            this.changeList(r)
        }
        t.table.find("." + o).parent().addClass("btn-warning")
    }, o.prototype.changeList = function (o) {
        var t = this.options;
        this.updateButtonBar(o);
        for (var r = t.table.find("tbody").empty(), a = (o - 1) * t.rows * t.cols, i = 0; i < t.rows; i++) {
            for (var s = e("<tr></tr>"), n = 0; n < t.cols; n++) {
                var l = a + i * t.cols + n, c = e('<button class="btn btn-default btn-icon"></button>').hide();
                if (l < t.icons.length) {
                    var p = t.iconClassFix + t.icons[l];
                    c = e('<button class="btn btn-default btn-icon" value="' + p + '" title="' + p + '"><i class="' + t.iconClass + " " + p + '"></i></button>')
                }
                var d = e("<td></td>").append(c);
                s.append(d)
            }
            r.append(s)
        }
        t.page = o, this.bindEvents()
    }, o.prototype.setIcon = function (e) {
        this.select(e)
    };
    var t = e.fn.iconpicker;
    e.fn.iconpicker = function (t, r) {
        return this.each(function () {
            var a = e(this), i = a.data("bs.iconpicker"), s = "object" == typeof t && t;
            if (i || a.data("bs.iconpicker", i = new o(this, s)), "string" == typeof t)i[t](r); else {
                var n = i.options, l = "fontawesome" == n.iconset ? "fa" : "glyphicon";
                n = e.extend(n, {
                    icons: o.ICONSET[l],
                    iconClass: l,
                    iconClassFix: l + "-",
                    page: 1,
                    selected: -1,
                    table: e('<table class="table-icons"><thead></thead><tbody></tbody></table>')
                });
                var c = "undefined" != typeof a.attr("name") ? 'name="' + a.attr("name") + '"' : "";
                a.empty().append("<i></i>").append('<input type="hidden" ' + c + "></input>").append('<span class="caret"></span>'), a.addClass("iconpicker"), i.createButtonBar(), i.changeList(1), a.on("click", function (e) {
                    e.preventDefault(), a.popover({
                        animation: !1,
                        trigger: "manual",
                        html: !0,
                        content: i.options.table,
                        container: "body",
                        placement: i.options.placement
                    }).on("shown.bs.popover", function () {
                        i.switchPage(n.icon), i.bindEvents()
                    }), a.data("bs.popover").tip().addClass("iconpicker-popover"), a.popover("show")
                }), i.select(n.icon)
            }
        })
    }, e.fn.iconpicker.Constructor = o, e.fn.iconpicker.noConflict = function () {
        return e.fn.iconpicker = t, this
    }, e("body").on("click", function (o) {
        e(".iconpicker").each(function () {
            e(this).is(o.target) || 0 !== e(this).has(o.target).length || 0 !== e(".popover").has(o.target).length || e(this).popover("destroy")
        })
    }), e('button[role="iconpicker"]').iconpicker()
}(window.jQuery);